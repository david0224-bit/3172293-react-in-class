...
import { builReportDataset } from "../utils/buildReportDataset";

// Servicios de exportacion
import { generateExcelReport } from "./generate/generateExcelReport";
...
export function generateUserReport({
    ...
    const { headers, rows } = builReportDataset({
        users,
        selectedFields,
        scope,
        documentNumber
